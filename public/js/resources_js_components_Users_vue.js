  ...
  computed: {
    ...
    serchFactoryusers: function serchFactoryusers() {
      ...
      for (var i in this.factoryusers) {
        ...
        if (factoryuserData.factoryuser_name.indexOf(this.keyword) !== -1 && room_number.slice(0, -3).indexOf(this.floorKeyword) !== -1 && factoryuserData.care_level.indexOf(this.serchCareLevelKeyword) !== -1) {
